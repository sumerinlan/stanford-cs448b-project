...
function w(n, i, o, a) {
    let s, l, u, c, d = t(n);
    n instanceof Map ? (s = `Map(${n.size})`, l = g) : n instanceof Set ? (s = `Set(${n.size})`, l = y) : d ? (s = `${n.constructor.name}(${n.length})`, l = E) : (c = m(n)) ? (s = `Immutable.${c.name}${"Record"===c.name?"":`(${n.size})`}`, d = c.arrayish, l = c.arrayish ? C : c.setish ? x : P) : a ? (s = f(n), l = N) : (s = f(n), l = S);
    const h = document.createElement("span");
    h.className = "observablehq--expanded", o && h.appendChild(r(o));
    const p = h.appendChild(document.createElement("a"));
    p.innerHTML = "<svg width=8 height=8 class='observablehq--caret'>\n    <path d='M4 7L0 1h8z' fill='currentColor' />\n  </svg>", p.appendChild(document.createTextNode(`${s}${d?" [":" {"}`)), p.addEventListener("mouseup", function(e) { e.stopPropagation(), se(h, k(n, null, o, a)) }), l = l(n);
    ...
    if (!u.done) {
        ...
        t.className = "observablehq--field", t.style.display = "block", t.appendChild(document.createTextNode("  … more")), t.addEventListener("mouseup", function(t) {
            t.stopPropagation(), h.insertBefore(u.value, h.lastChild.previousSibling);
            for (let e = 0; !(u = l.next()).done && e < 19; ++e) h.insertBefore(u.value, h.lastChild.previousSibling);
...
function* N(e) {
    for (const t in b(e)) yield M(t, h(e, t), "observablehq--key");
    for (const t of c(e)) yield M(o(t), h(e, t), "observablehq--symbol");
    const t = v(e);
    t && t !== _ && (yield q(t))
}

function* S(e) {
    for (const t in e) d(e, t) && (yield M(t, h(e, t), "observablehq--key"));
    for (const t of c(e)) yield M(o(t), h(e, t), "observablehq--symbol");
    const t = v(e);
    t && t !== _ && (yield q(t))
}
...
function q(e) {
    ...
    return t.className = "observablehq--field", n.className = "observablehq--prototype-key", n.textContent = "  <prototype>", t.appendChild(document.createTextNode(": ")), t.appendChild(ae(e, void 0, void 0, void 0, !0)), t
}

function M(e, t, n) {
    const r = document.createElement("div"),
        i = r.appendChild(document.createElement("span"));
    return r.className = "observablehq--field", i.className = n, i.textContent = `  ${e}`, r.appendChild(document.createTextNode(": ")), r.appendChild(ae(t)), r
}
...
function* U(e) {
    let t = -1,
        n = 0;
    for (const r = e.size; n < r; ++n) n > t + 1 && (yield I(n - t - 1)), yield ae(e.get(n), !0), t = n;
    n > t + 1 && (yield I(n - t - 1))
}
...
function* R(e) {
    let t = -1,
        r = 0;
    for (const n = e.length; r < n; ++r) r in e && (r > t + 1 && (yield I(r - t - 1)), yield ae(h(e, r), !0), t = r);
    r > t + 1 && (yield I(r - t - 1));
    for (const t in e) !n(t) && d(e, t) && (yield z(t, h(e, t), "observablehq--key"));
    for (const t of c(e)) yield z(o(t), h(e, t), "observablehq--symbol")
}
...
function z(e, t, n) {
    const r = document.createDocumentFragment(),
        i = r.appendChild(document.createElement("span"));
    return i.className = n, i.textContent = e, r.appendChild(document.createTextNode(": ")), r.appendChild(ae(t, !0)), r
}
...
function ae(e, t, n, i, a) {
    ...
    switch (s) {
                ...
                if (!1 === t) {
                    ...
                    if (o.length > K && !n) {
                        ...
                        const s = n.appendChild(document.createElement("span")),
                            l = o.length - K;
                        return s.textContent = `Show ${l} truncated line${l>1?"s":""}`, s.className = "observablehq--string-expand", s.addEventListener("mouseup", function(r) { r.stopPropagation(), se(n, ae(e, t, !0, i)) }), n
                    }
        ...
        default:
            if (null === e) { s = null, e = "null"; break }
            if (e instanceof Date) { s = "date", l = e, e = isNaN(l) ? "Invalid Date" : function(e) { return 0 === e.getUTCMilliseconds() && 0 === e.getUTCSeconds() && 0 === e.getUTCMinutes() && 0 === e.getUTCHours() }(l) ? W(l.getUTCFullYear()) + "-" + H(l.getUTCMonth() + 1, 2) + "-" + H(l.getUTCDate(), 2) : W(l.getFullYear()) + "-" + H(l.getMonth() + 1, 2) + "-" + H(l.getDate(), 2) + "T" + H(l.getHours(), 2) + ":" + H(l.getMinutes(), 2) + (l.getMilliseconds() ? ":" + H(l.getSeconds(), 2) + "." + H(l.getMilliseconds(), 3) : l.getSeconds() ? ":" + H(l.getSeconds(), 2) : ""); break }
            if (e === u) { s = "forbidden", e = "[forbidden]"; break }
            switch (oe.call(e)) {
                case "[object RegExp]":
                    s = "regexp", e = function(e) { return G.call(e) }(e);
                    break;
                case "[object Error]":
                case "[object DOMException]":
                    s = "error", e = function(e) { return e.stack || V.call(e) }(e);
                    break;
                default:
...
class ue {
    ...
    rejected(t, n) {
        ...
        o.className = "observablehq--inspect", n && o.appendChild(r(n)), o.appendChild(document.createTextNode((t + "").replace(le, ""))), i.appendChild(o), e(i, "error", { error: t })
    }
}
async function ce(e) { const t = await fetch(await e.url()); if (!t.ok) throw new Error(`Unable to load file: ${e.name}`); return t } ue.into = function(e) { if ("string" == typeof e && null == (e = document.querySelector(e))) throw new Error("container not found"); return function() { return new ue(e.appendChild(document.createElement("div"))) } };
class FileAttachment {
    constructor(e, t) { Object.defineProperties(this, { _url: { value: e }, name: { value: t, enumerable: !0 } }) } async url() { return this._url } async blob() { return (await ce(this)).blob() } async arrayBuffer() { return (await ce(this)).arrayBuffer() } async text() { return (await ce(this)).text() } async json() { return (await ce(this)).json() } async stream() { return (await ce(this)).body } async image() {
...
var Ce = Ne(async function(e, t) {
    if (e.startsWith(be) && (e = e.substring(be.length)), /^(\w+:)|\/\//i.test(e)) return e;
    ...
    if (n.path && !ge.test(n.path) && (n.path += ".js"), n.path && n.version && we.test(n.version)) return `${be}${n.name}@${n.version}/${n.path}`;
    const r = await Ee(n);
    return `${be}${r.name}@${r.version}/${n.path||function(e){for(const t of ye){const n=e[t];if("string"==typeof n)return ge.test(n)?n:`${n}.js`}}(r)||"index.js"}`
});
...
function Ne(e) {
    ...
    function r(e) {
        ...
        return n || t.set(e, n = new Promise((t, n) => {
            ...
            r.onload = () => { try { t(he.pop()(i(e))) } catch (e) { n(new RequireError("invalid module")) } r.remove() }, r.onerror = () => { n(new RequireError("unable to load module")), r.remove() }, r.async = !0, r.src = e, window.define = Me, document.head.appendChild(r)
        })), n
    }

    function i(t) { return n => Promise.resolve(e(n, t)).then(r) }

    function o(e) { return arguments.length > 1 ? Promise.all(pe.call(arguments, n)).then(Se) : n(e) }
    return o.alias = function(t) { return Ne((n, r) => n in t && (r = null, "string" != typeof(n = t[n])) ? n : e(n, r)) }, o.resolve = e, o
}

function Se(e) {
    const t = {};
    for (const n of e)
        for (const e in n) ve.call(n, e) && (null == n[e] ? Object.defineProperty(t, e, { get: Pe(n, e) }) : t[e] = n[e]);
    return t
}
...
function Me(e, t, n) {
    ...
    r < 2 ? (n = e, t = []) : r < 3 && (n = t, t = "string" == typeof e ? [] : e), he.push(me.call(t, qe) ? e => {
        const r = {},
            i = { exports: r };
...
var Te = {
    canvas: function(e, t) { var n = document.createElement("canvas"); return n.width = e, n.height = t, n },
    ...
    input: function(e) { var t = document.createElement("input"); return null != e && (t.type = e), t },
    range: function(e, t, n) { 1 === arguments.length && (t = e, e = null); var r = document.createElement("input"); return r.min = e = null == e ? 0 : +e, r.max = t = null == t ? 1 : +t, r.step = null == n ? "any" : n = +n, r.type = "range", r },
    select: function(e) {
    ...
    svg: function(e, t) { var n = document.createElementNS("http://www.w3.org/2000/svg", "svg"); return n.setAttribute("viewBox", [0, 0, e, t]), n.setAttribute("width", e), n.setAttribute("height", t), n },
    text: function(e) { return document.createTextNode(e) },
    uid: function(e) { return new ke("O-" + (null == e ? "" : e + "-") + ++je) }
};
var Ae = {
    buffer: function(e) {
        return new Promise(function(t, n) {
            var r = new FileReader;
            r.onload = function() { t(r.result) }, r.onerror = n, r.readAsArrayBuffer(e)
        })
    },
    text: function(e) {
        return new Promise(function(t, n) {
            var r = new FileReader;
            r.onload = function() { t(r.result) }, r.onerror = n, r.readAsText(e)
        })
    },
    url: function(e) {
        return new Promise(function(t, n) {
...
function Re(e) {
    let t, n, r = !1;
    const i = e(function(e) { n ? (n(e), n = null) : r = !0; return t = e });
    return {
        [Symbol.iterator]: Oe,
        throw: () => ({ done: !0 }),
        return: () => (null != i && i(), { done: !0 }),
        next: function() { return { done: !1, value: r ? (r = !1, Promise.resolve(t)) : new Promise(e => n = e) } }
    }
}
...
var Fe = {
    disposable: Ue,
    filter: function*(e, t) { for (var n, r = -1; !(n = e.next()).done;) t(n.value, ++r) && (yield n.value) },
    input: function(e) {
        return Re(function(t) {
            ...
            return e.addEventListener(n, i), void 0 !== r && t(r),
                function() { e.removeEventListener(n, i) }
        })
    },
    map: function*(e, t) { for (var n, r = -1; !(n = e.next()).done;) yield t(n.value, ++r) },
    observe: Re,
    queue: function(e) {
        let t;
        const n = [],
            r = e(function(e) { n.push(e), t && (t(n.shift()), t = null); return e });
        return {
            [Symbol.iterator]: Oe,
            throw: () => ({ done: !0 }),
            return: () => (null != r && r(), { done: !0 }),
            next: function() { return { done: !1, value: n.length ? Promise.resolve(n.shift()) : new Promise(e => t = e) } }
        }
    },
    range: function*(e, t, n) { e = +e, t = +t, n = (i = arguments.length) < 2 ? (t = e, e = 0, 1) : i < 3 ? 1 : +n; for (var r = -1, i = 0 | Math.max(0, Math.ceil((t - e) / n)); ++r < i;) yield e + r * n },
    ...
    worker: function(e) {
        const t = URL.createObjectURL(new Blob([e], { type: "text/javascript" })),
            n = new Worker(t);
        return Ue(n, () => { n.terminate(), URL.revokeObjectURL(t) })
    }
};
    ...
    return function(n) {
        ...
        for (s = 1, l = arguments.length; s < l; ++s) {
            if ((r = arguments[s]) instanceof Node) f[++p] = r, d += "\x3c!--o:" + p + "--\x3e";
                ...
                for (u = 0, c = r.length; u < c; ++u)(i = r[u]) instanceof Node ? (null === h && (f[++p] = h = document.createDocumentFragment(), d += "\x3c!--o:" + p + "--\x3e"), h.appendChild(i)) : (h = null, d += i);
                h = null
            } else d += r;
            d += n[s]
        }
        if (h = e(d), ++p > 0) { for (o = new Array(p), a = document.createTreeWalker(h, NodeFilter.SHOW_COMMENT, null, !1); a.nextNode();) i = a.currentNode, /^o:/.test(i.nodeValue) && (o[+i.nodeValue.slice(2)] = i); for (s = 0; s < p; ++s)(i = o[s]) && i.parentNode.replaceChild(f[s], i) }
            ...
            return Ie(function(n) {
                ...
                return i.length > 0 && e(Be + "highlight.min.js").then(function(t) {
                    i.forEach(function(n) {
                        function r() { t.highlightBlock(n), n.parentNode.classList.add("observablehq--md-pre") } t.getLanguage(n.className) ? r() : e(Be + "async-languages/index.js").then(r => { if (r.has(n.className)) return e(Be + "async-languages/" + r.get(n.className)).then(e => { t.registerLanguage(n.className, e) }) }).then(r, r)
                    })
                }), r
...
function tt(e) {
    return function() {
        return Promise.all([e("@observablehq/katex@0.11.1/dist/katex.min.js"), e.resolve("@observablehq/katex@0.11.1/dist/katex.min.css").then(et)]).then(function(e) {
            ...
            function r(e) { return function() { var n = document.createElement("div"); return t.render(Ze.apply(String, arguments), n, e), n.removeChild(n.firstChild) } }
...
function gt(e, t, n) {
    ...
    if (this._inputs.forEach(bt, this), t.forEach(vt, this), this._inputs = t, this._definition = n, this._value = void 0, n === ct ? i._variables.delete(this) : i._variables.add(this), e == this._name && r.get(e) === this) this._outputs.forEach(i._updates.add, i._updates);
    else {
        var o, a;
        if (this._name)
...
function xt(e) { return e._name } Object.defineProperties(mt.prototype, {
    _pending: { value: function() { this._observer.pending && this._observer.pending() }, writable: !0, configurable: !0 },
    _fulfilled: { value: function(e) { this._observer.fulfilled && this._observer.fulfilled(e, this._name) }, writable: !0, configurable: !0 },
    _rejected: { value: function(e) { this._observer.rejected && this._observer.rejected(e, this._name) }, writable: !0, configurable: !0 },
    define: {
    ...
    delete: { value: function() { return gt.call(this, null, [], ct) }, writable: !0, configurable: !0 },
    import: { value: function(e, t, n) { arguments.length < 3 && (n = t, t = e); return gt.call(this, t + "", [n._resolve(e + "")], ut) }, writable: !0, configurable: !0 }
    ...
    _resolve: {
        value: function(e) {
            ...
            else { try { t = this._runtime._global(e) } catch (t) { return n.define(e, (r = t, function() { throw r })) } void 0 === t ? this._scope.set(n._name = e, n) : n.define(e, lt(t)) }
            var r;
            return n
        },
        writable: !0,
    ...
    redefine: { value: function(e) { var t = this._scope.get(e); if (!t) throw new it(e + " is not defined"); if (t._type === ht) throw new it(e + " is defined more than once"); return t.define.apply(t, arguments) }, writable: !0, configurable: !0 },
    define: { value: function() { var e = new mt(dt, this); return e.define.apply(e, arguments) }, writable: !0, configurable: !0 },
    derive: {
        value: function(e, t) {
            var n = new yt(this._runtime, this._builtins);
            return n._source = this, st.call(e, function(e) { "object" != typeof e && (e = { name: e + "" }), null == e.alias && (e.alias = e.name), n.import(e.name, e.alias, t) }), Promise.resolve().then(() => {
    ...
    import: { value: function() { var e = new mt(dt, this); return e.import.apply(e, arguments) }, writable: !0, configurable: !0 },
    value: {
    ...
    variable: { value: function(e) { return new mt(dt, this, e) }, writable: !0, configurable: !0 },
    builtin: { value: function(e, t) { this._builtins.set(e, t) }, writable: !0, configurable: !0 }
});
const Et = "function" == typeof requestAnimationFrame ? requestAnimationFrame : setImmediate;
var Ct = {},
    Nt = {};

function St(e = new rt, t = function(e) { return window[e] }) {
    var n = this.module();
    if (Object.defineProperties(this, { _dirty: { value: new Set }, _updates: { value: new Set }, _computing: { value: null, writable: !0 }, _init: { value: null, writable: !0 }, _modules: { value: new Map }, _variables: { value: new Set }, _disposed: { value: !1, writable: !0 }, _builtin: { value: n }, _global: { value: t } }), e)
...
function jt(e, t) {
    let n, r, i = "function" == typeof IntersectionObserver && t._observer && t._observer._node,
        ...
        a = ct,
        s = ct;
    return i && ((r = new IntersectionObserver(([e]) => (o = e.isIntersecting) && (n = null, a()))).observe(i), e.then(() => (r.disconnect(), r = null, s()))),
...
function kt(e) {
    ...
    var t = e._value,
        ...
        i = e._promise = Promise.all(e._inputs.map($t)).then(function(i) {
            ...
            return function(e) { return e && "function" == typeof e.next && "function" == typeof e.return }(t) ? e._version !== n ? void t.return() : ((r || Lt(e)).then((o = t, function() { o.return() })), function(e, t, n, r) {
                function i() {
                    var n = new Promise(function(e) { e(r.next()) }).then(function(r) { return r.done ? void 0 : Promise.resolve(r.value).then(function(r) { if (e._version === t) return Tt(e, r, n).then(i), e._fulfilled(r), r }) });
                    n.catch(function(r) { e._version === t && (Tt(e, void 0, n), e._rejected(r)) })
                }
                return new Promise(function(e) { e(r.next()) }).then(function(e) { if (!e.done) return n.then(i), e.value })
            }(e, n, i, t)) : t;
            var o
        });
...
function At(e, t) { e._invalidate(), e._invalidate = ct, e._pending(), ++e._version, e._indegree = NaN, (e._promise = Promise.reject(t)).catch(ct), e._value = void 0, e._rejected(t) } Object.defineProperties(St, {
    load: {
        value: function(e, t, n) {
            if ("function" == typeof t && (n = t, t = null), "function" != typeof n) throw new Error("invalid observer");
            null == t && (t = new rt);
            const { modules: r, id: i } = e, o = new Map, a = new St(t), s = l(i);

            function l(e) { let t = o.get(e); return t || o.set(e, t = a.module()), t }
            for (const e of r) { const t = l(e.id); let r = 0; for (const i of e.variables) i.from ? t.import(i.remote, i.name, l(i.from)) : t === s ? t.variable(n(i, r, e.variables)).define(i.name, i.inputs, i.value) : t.define(i.name, i.inputs, i.value), ++r }
            return a
        },
        writable: !0,
        configurable: !0
    ...
    _compute: { value: function() { return this._computing || (this._computing = this._computeSoon()) }, writable: !0, configurable: !0 },
    _computeSoon: { value: function() { var e = this; return new Promise(function(t) { Et(function() { t(), e._disposed || e._computeNow() }) }) }, writable: !0, configurable: !0 },
    _computeNow: {
        value: function() {
            var e, t, n = [];
            ...
            }, this), (e = new Set(this._updates)).forEach(function(t) { t._reachable ? (t._indegree = 0, t._outputs.forEach(e.add, e)) : (t._indegree = NaN, e.delete(t)) }), this._computing = null, this._updates.clear(), this._dirty.clear(), e.forEach(function(e) { e._outputs.forEach(qt) });
            do {
                for (e.forEach(function(e) { 0 === e._indegree && n.push(e) }); t = n.pop();) kt(t), t._outputs.forEach(r), e.delete(t);
                e.forEach(function(t) { Pt(t) && (At(t, new it("circular definition")), t._outputs.forEach(Mt), e.delete(t)) })
            } while (e.size);

            function r(e) { 0 == --e._indegree && n.push(e) }
        },
        writable: !0,
        configurable: !0
    },
    dispose: { value: function() { this._computing = Promise.resolve(), this._disposed = !0, this._variables.forEach(e => { e._invalidate(), e._version = NaN }) }, writable: !0, configurable: !0 },
    module: {
        value: function(e, t = ct) {
            ...
            try { e(this, t) } finally { this._init = null }
            return n
        },
        writable: !0,
        configurable: !0
    },
    fileAttachments: { value: function(e) { return t => { const n = e(t += ""); if (null == n) throw new Error(`File not found: ${t}`); return new FileAttachment(n, t) } }, writable: !0, configurable: !0 }
});
